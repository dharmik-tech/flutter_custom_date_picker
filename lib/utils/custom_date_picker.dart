...
class _CustomCalendarDatePickerState extends State<CustomCalendarDatePicker> {
  ...
  void _handleMonthChanged(DateTime date) {
    setState(() {
      if (widget.currentDisplayedMonthDate != null &&
              widget.currentDisplayedMonthDate!.year != date.year ||
          widget.currentDisplayedMonthDate!.month != date.month) {
        widget.currentDisplayedMonthDate = DateTime(date.year, date.month);
        widget.onDisplayedMonthChanged?.call(widget.currentDisplayedMonthDate!);
      }
    });
  }
  ...
  Widget _buildPicker() {
    switch (_mode) {
      case DatePickerMode.day:
        return _MonthPicker(
          key: _monthPickerKey,
          initialMonth: widget.currentDisplayedMonthDate ?? DateTime.now(),
      ...
      case DatePickerMode.year:
        return Padding(
          ...
          child: YearPicker(
            ...
            firstDate: widget.firstDate,
            lastDate: widget.lastDate,
            initialDate: widget.currentDisplayedMonthDate,
            selectedDate: widget.currentDisplayedMonthDate!,
...
class _MonthPickerState extends State<_MonthPicker> {
  ...
  void _handleDateSelected(DateTime selectedDate) {
    ...
    // _showMonth(selectedDate,jump: true);
    // _handleNextMonth();
    //  _handleMonthPageChanged(1) ;
  }
  ...
  void _handleNextMonth() {
    if (!_isDisplayingLastMonth) {
      ...
      setState(() {
        _currentMonth = _currentMonth.add(const Duration(days: 31));
      });
    }
  }
  ...
  void _handlePreviousMonth() {
    if (!_isDisplayingFirstMonth) {
      ...
      setState(() {
        _currentMonth = _currentMonth.subtract(const Duration(days: 31));
      });
    }
  }
        ...
        children: <Widget>[
          Row(
            ...
            children: [
              ...
              MaterialButton(
                onPressed: () {
                  _handleDateSelected((_focusedDay ?? DateTime.now())
                ...
                height: 36,
                child: Text(
                    'Next ${intl.DateFormat(intl.DateFormat.WEEKDAY).format(_focusedDay ?? DateTime.now())}',
          ...
          Row(
            ...
            children: [
              MaterialButton(
                ...
                height: 36,
                child: Text(
                  'Next ${intl.DateFormat(intl.DateFormat.WEEKDAY).format((_focusedDay ?? DateTime.now()).add(const Duration(days: 1)))}',
                  style: const TextStyle(
                    color: AppColor.primaryBlue,
                    fontSize: 14,
                  ),
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                Text(intl.DateFormat(
                        '${intl.DateFormat.STANDALONE_MONTH} ${intl.DateFormat.YEAR}')
                    .format(_currentMonth)),
                // _DatePickerModeToggleButton(
                //   mode: DatePickerMode.day,
                //   title:
                //       _localizations.formatMonthYear(widget.selectedDate),
                //   // onTitlePressed: () {
